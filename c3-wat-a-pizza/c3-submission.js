...
function calculatePizzaPrice(noOfItems, price) {
...
console.log(" Pizza Price = "+pizzaPrice1)
console.log("Total pizza price = "+totalPizzaPrice)
console.log("Total beverage price = "+totalBeveragePrice)